...
"""Verify that starting digitaleuro with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start digitaleuro with -h for help text")
        ...
        self.log.info("Start digitaleuro with -version for version information")
