...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s digitaleuro-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  digitaleuro-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitaleuro transaction") + "\n" +
              "  digitaleuro-tx [options] -create [commands]   " + _("Create hex-encoded digitaleuro transaction") + "\n" +
              "\n";
